...
namespace FilterHomeWork
{
    public partial class MainForm : Form
    {
        ...
        private IEnumerable<FilterNameModel> GetFilterNameModels() 
        {
            ...
            var filterNameValue = from x in this._context.FilterNameValues.AsQueryable() select x;
        ...
        private void GbFilter_Click(object sender, EventArgs e) 
        {
            ...
            var checkedList = this.Controls.OfType<GroupBox>().Where(x => x.Name == $"gbFilter{FilterName.Id}")
                .SingleOrDefault().Controls.OfType<CheckedListBox>().FirstOrDefault();
